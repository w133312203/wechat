...
<style>
    ...
    #optionModal textarea#optionContent{
	...
	#optionModal .wordQ{
		text-align: right; padding: 0px 5%;
	}
</style>
<nav class="navbar navbar-default navbar-static-top" role="navigation" >	    	
                					...
                					<div class="col-md-4" style="padding: 0px;">
                						<div class="btn-group personalbox">
			                                ...
			                                <ul class="dropdown-menu" style="background-color: #333333 !important;">
			                                   ...
			                                   <li><a id="cuInfo" href="javascript:void(0);" data-toggle="modal" data-target="#optionModal">意见反馈</a></li> 
	   ...
	   <div class="modal fade" id="optionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		   	<div class="modal-dialog">
		       	<div class="modal-content">
		            ...
		            <!-- onkeyup="javascript:checkWords(this);"  onmousedown="javascript:checkWords(this);" -->
		               <textarea name="content" id="optionContent"></textarea>
	                  <!--  <div class="wordQ">  
			                                   还可以输入<span style="font-family: Georgia; font-size: 26px;" id="wordCheck">600</span>字  
			           </div> -->
	...
	/*    var maxstrlen=600;
	    ...
	    function submit(){
	      var contents=	$("#optionContent").val();
	    	$.ajax({
         		type: "POST",
         		url: "${ctx }/option",
         		dataType: "json",
