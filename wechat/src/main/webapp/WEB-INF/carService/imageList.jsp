			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalTitle">删除车辆图片</h4>
					</div>
					<div class="modal-body">
						<form action="${ctx}/carService/deleteImage" method="post" id="delFieldForm">
		...
		<div class="modal fade" id="carModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                <h4 class="modal-title" id="myModalLabel">添加车辆图片</h4>
		            </div>
					<div class="modal-body">
						<form action="${ctx }/carService/editImage" method="post" id="fieldForm" enctype="multipart/form-data">
							<input type="hidden" name="carId" value="${carId}" />
							<input type="file" id="upload" accept="image/*" name="imageFile" style="display:none" />
							<div class="container-fluid">
								<div class="row">
		                        	<div class="form-group" style="text-align: center;">
				                        <img src="" style="border-radius: 50%;width: 85px;height: 85px" id="pic">
			                           	...
			                           	<div class="form-group">
			                               	<p style="padding-top:8px">
												<label class="radio-inline" style="line-height:10px">
													<input type="radio" name="type" value="0" checked = "checked"/> 宣传图片
												</label>
												<label class="radio-inline" style="line-height:10px">
													<input type="radio" name="type" value="1"/> 配置图片
												</label>
											</p>
			                           	</div>
			                        </div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$table.bootstrapTable({
					...
					url:'${ctx}/carService/showImageListJson?carId='+${carId}
				});
				...
				$(".bars").append("<div onclick='addField()' class='mark-tag' data-toggle='modal' data-target='#carModal'>添加图片</div>");
				$(".bars .mark-tag").css({
					width: "auto",
					float: "right",
					display: "inline-block",
