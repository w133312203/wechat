			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${ctx}/reply/editTextReply" method="post" id="keywordsForm">
							...
							<div class="container-fluid">
		                        ...
		                        <div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<label>文本内容</label>
											<p id="errcontent" data-container="body" tabindex="0" role="button"  data-toggle="popover" data-trigger="focus" data-placement="top" data-content="文本内容未填写">
												<textarea placeholder="文本内容" class="form-control" id="content" name="content" rows="8" cols="8"></textarea>
											</p>
										</div>
									</div>
								</div>
		...
		<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${ctx}/reply/deleteTextReply" method="post" id="delKeywordsForm">
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
		    	...
		    	$table.bootstrapTable({
					...
					url:'${ctx}/reply/showTextReplyListJson'
				});
		        ...
		        $(".search").append("<div onclick='addKeywords()' class='mark_zj' data-toggle='modal' data-target='#myModal'>添加文本回复规则</div>");
		        $(".search .mark_zj").css({
		            width: "auto",
			        float: "right",
			    ...
			    $(".bars").append("<span class='mark_h1'>文本回复规则</span>");
			...
			function operateFormatter(value, row, index) {
				return [
		    	            '<a onclick="editKeywords('+row.id+',\''+row.keywords+'\',\''+row.status+'\',\''+row.content+'\')" href="javascript:void(0)" data-toggle="modal" data-target="#myModal" title="修改">',
			...
			function toMessage(id) {
				$("#messageForm").attr("action", "${ctx}/wx/textkey/text");
				$('#toKeywordsId').val(id);
				$('#messageForm').submit();
			}
